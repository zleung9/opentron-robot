...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def locat_dict():
        source_wells1 = ['A1', 'A2', 'A3', 'A4', 'B1', 'B2', 'B3', 'B4']
        source_wells2 = ['A1', 'A2', 'A3', 'A4']
        return {'source1':source_wells1, 'source2':source_wells2}
    
    def cond_measurement(plate, loc):
        left_pipette.move_to(plate[loc].top(60))
        left_pipette.move_to(plate[loc].bottom(80))
